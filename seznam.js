const filmy = [
	{
		id: 'hunger-games',
		nazev: 'Hunger Games: Balada o ptácích a hadech',
		plakat: {
			url: 'https://www.cine-max.cz/fileadmin//user_upload/hunger-games-balada-00cz.jpg',
			sirka: 663,
			vyska: 909,
		},
		ochutnavka: 'Jak to celé začalo? Kdo je Coriolanus Snow?',
		popis:
...
//4.úkol + BONUS - přidání Hunger Games
